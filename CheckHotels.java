...
public class CheckHotels extends JFrame implements Runnable{
    ...
    public void run() {
        ...
        String[] text = new String[]{ "JW Marriot Hotel", "Madarian Oriental Hotel", "Four Seasons Hotel" , "Raddisson Blue Hotel", "Taj Mahal Palace","The Oberoi Hotel","Lemon Tree Hotel","Hyatt Hotel","Hotel Tip Top", "The Bay Club Hotel"};
